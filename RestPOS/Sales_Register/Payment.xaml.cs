    ...
    public partial class Payment : Window
    {
            ...
            else
            {
                try
                {
                    if (Convert.ToDouble(txtPaidAmount.Text) >= Convert.ToDouble(lblTotalPayable.Text))
                    {
                       ...
                       // changeAmt = Math.Round(changeAmt, 2);modeficado
                ...
                else
                {
                  ...
                  //  lblsubtotal.Text = subtotalafteroveralldiscount.ToString();
                   ...
                   // payable = Math.Round(payable, 2);
                    lblTotalPayable.Text = subtotal.ToString();
        ...
        // Coin and Notes
            private void btnCoin1_Click(object sender, RoutedEventArgs e)
            {
                ...
                {
                    txtPaidAmount.Text = "0.00";
                    txtPaidAmount.Text = (Convert.ToDouble(txtPaidAmount.Text) + Convert.ToDouble("1.00")).ToString();
                }
                else
                {
                    txtPaidAmount.Text = (Convert.ToDouble(txtPaidAmount.Text) + Convert.ToDouble("1.00")).ToString();
            ...
            private void btnCoin2_Click(object sender, RoutedEventArgs e)
            {
                ...
                {
                    txtPaidAmount.Text = "0.00";
                    txtPaidAmount.Text = (Convert.ToDouble(txtPaidAmount.Text) + Convert.ToDouble("2.00")).ToString();
                }
                else
                {
                    txtPaidAmount.Text = (Convert.ToDouble(txtPaidAmount.Text) + Convert.ToDouble("2.00")).ToString();
            ...
            private void btnNote5_Click(object sender, RoutedEventArgs e)
            {
                ...
                {
                    txtPaidAmount.Text = "0.00";
                    txtPaidAmount.Text = (Convert.ToDouble(txtPaidAmount.Text) + Convert.ToDouble("5.00")).ToString();
                }
                else
                {
                    txtPaidAmount.Text = (Convert.ToDouble(txtPaidAmount.Text) + Convert.ToDouble("5.00")).ToString();
            ...
            private void CombPayby_SelectionChanged(object sender, SelectionChangedEventArgs e)
            {
